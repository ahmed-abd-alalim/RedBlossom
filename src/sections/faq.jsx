...
const Faq = () => {
  return (
    <section className="relative bg-[url(/images/bgs/6.webp)] bg-[position:center_lefy] md:bg-[position:center_center] bg-[length:300%]  xl:bg-[length:110%] bg-no-repeat xl:h-[45rem] xl:-translate-y-10">
      <div className="text-center xl:hidden px-2">
        <h2 className="font-juzhokaizen text-black text-[1.7rem] lg:text-[2.4rem] text-center">
          Questions & Answers
        </h2>
      </div>

      <div className="relative z-3 w-full h-full hidden xl:grid grid-cols-2">
        <h3 className="abs-center font-juzhokaizen text-[2.4rem]">
          Questions & Answers
        </h3>
        <div className="flex flex-col justify-between py-20 px-20">
          <div className="w-50 h-55 bg-white rounded-3xl shadow-[5px_3px_10px_1px] shadow-soft-black flex flex-col justify-between px-8 py-7">
        ...
        <div className="flex flex-col justify-between items-end py-20 px-20">
          <div className="w-50 h-55 bg-white rounded-3xl shadow-[5px_3px_10px_1px] shadow-soft-black flex flex-col justify-between px-8 py-7 -translate-x-25">
            <h3 className="font-juzhokaizen text-[1.2rem]/6">
      ...
      <div className="relative z-3 w-full h-full xl:hidden mt-8">
        <div className="w-[85%] md:w-[60%] h-18 bg-white rounded-3xl shadow-[5px_3px_10px_1px] shadow-soft-black px-6 py-8 m-auto overflow-hidden group">
        ...
        <div className="w-[85%] md:w-[60%] h-18 bg-white rounded-3xl shadow-[5px_3px_10px_1px] shadow-soft-black px-6 py-8 mt-4 m-auto overflow-hidden group">
          <div className="h-[35%] flex justify-between items-center cursor-pointer group-[.h-18]:mt-2">
            <h3 className="w-[85%] font-juzhokaizen text-black text-[1.1rem]/5">
              What chain is used?
            </h3>
      ...
      <div className="w-[35%] md:w-[25%] xl:w-[20%] absolute z-1 top-5 -right-0 translate-x-10">
        <div>
      ...
      <div className="w-[35%] md:w-[25%] xl:w-[20%] absolute z-1 -top-15 -left-0 -translate-x-10">
        <div>
